from ._anvil_designer import CALIDAD_CONTROLDOCUMENTOS_DOCUMENTOS_EXISTENTES_copyTemplate
from anvil import *
...
class CALIDAD_CONTROLDOCUMENTOS_DOCUMENTOS_EXISTENTES_copy(CALIDAD_CONTROLDOCUMENTOS_DOCUMENTOS_EXISTENTES_copyTemplate):
  datos = {}
